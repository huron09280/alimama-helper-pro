    ...
    const UI = {
        ...
        injectStyles() {
            ...
            const css = `
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-generate-control {
                    height: 30px;
                    display: inline-flex;
                    align-items: center;
                    border-radius: 9px;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-generate-control .am-ai-max-generate-btn {
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-generate-control .am-ai-max-toolbar-icon {
                    width: 26px;
                    color: inherit;
                    border-radius: 0 9px 9px 0;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-generate-control .am-ai-max-toolbar-icon:hover,
                #am-campaign-ai-max-batch-popup .am-ai-max-generate-control .am-ai-max-toolbar-icon:focus-visible {
                    background: transparent;
                    color: inherit;
                    box-shadow: none;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-toolbar-icon {
                    width: 28px;
                    height: 30px;
                    display: inline-flex;
                    align-items: center;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-toolbar-icon svg {
                    flex: 0 0 auto;
                    pointer-events: none;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-toolbar-icon:hover,
                #am-campaign-ai-max-batch-popup .am-ai-max-toolbar-icon:focus-visible {
                    background: transparent;
                    color: var(--am26-primary, #4554e5);
                    box-shadow: none;
                    transform: translateY(-1px);
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-prompt-slot:empty {
                    display: none;
                }
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-row:hover,
                #am-campaign-ai-max-batch-popup .am-ai-max-row:focus-within {
                    z-index: 4;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-row.is-demand-select-open {
                    z-index: 20;
                }
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-crowd-remove {
                    position: absolute;
                    top: -6px;
                    right: -6px;
                    width: 18px;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-popover:hover .am-ai-max-crowd-remove,
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-popover:focus-within .am-ai-max-crowd-remove,
                #am-campaign-ai-max-batch-popup .am-ai-max-crowd-remove:focus-visible {
                    display: flex;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-crowd-remove:hover {
                    background: rgba(254, 242, 242, 0.95);
                    color: #dc2626;
                    transform: scale(1.06);
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-crowd-remove:active {
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-row:hover .am-ai-max-row-actions,
                #am-campaign-ai-max-batch-popup .am-ai-max-row:focus-within .am-ai-max-row-actions,
                #am-campaign-ai-max-batch-popup .am-ai-max-row.is-demand-select-open .am-ai-max-row-actions {
                    opacity: 1;
                    pointer-events: auto;
                    transform: translateY(0);
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select {
                    position: relative;
                    display: inline-flex;
                    align-items: center;
                    min-width: 0;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select.is-open {
                    z-index: 3;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-trigger {
                    max-width: 142px;
                    background: rgba(69, 84, 229, 0.1);
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-trigger span {
                    min-width: 0;
                    overflow: hidden;
                    text-overflow: ellipsis;
                    white-space: nowrap;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-popover {
                    position: absolute;
                    right: 0;
                    top: calc(100% + 6px);
                    z-index: 2147483645;
                    ...
                    gap: 8px;
                    padding: 10px;
                    border: 1px solid rgba(69, 84, 229, 0.18);
                    border-radius: 10px;
                    background: rgba(255, 255, 255, 0.98);
                    box-shadow: 0 16px 36px rgba(39, 48, 83, 0.18);
                    box-sizing: border-box;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-popover[hidden] {
                    display: none;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-head,
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-foot {
                    min-width: 0;
                    display: flex;
                    align-items: center;
                    justify-content: space-between;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-head > span {
                    flex: 0 0 auto;
                    color: var(--am26-text-soft, #505a74);
                    font-size: 11px;
                    font-weight: 700;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-list {
                    min-width: 0;
                    max-height: 220px;
                    display: grid;
                    gap: 6px;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item {
                    position: relative;
                    min-width: 0;
                    min-height: 30px;
                    display: grid;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item.all {
                    flex: 1 1 auto;
                    min-height: 28px;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item:hover,
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item:has(input:focus-visible) {
                    border-color: rgba(69, 84, 229, 0.34);
                    background: #eef3ff;
                    outline: 2px solid var(--am26-focus, rgba(69, 84, 229, 0.32));
                    outline-offset: 1px;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item input {
                    position: absolute;
                    width: 1px;
                    height: 1px;
                    opacity: 0;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-check {
                    width: 16px;
                    height: 16px;
                    display: inline-flex;
                    align-items: center;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item input:checked + .am-ai-max-demand-select-check {
                    border-color: var(--am26-primary, #4554e5);
                    background: var(--am26-primary, #4554e5);
                    color: #ffffff;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item input:indeterminate + .am-ai-max-demand-select-check {
                    border-color: var(--am26-primary, #4554e5);
                    background: linear-gradient(180deg, #6b76ff, #4554e5);
                    color: transparent;
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-item input:indeterminate + .am-ai-max-demand-select-check::after {
                    content: "";
                    width: 8px;
                    height: 2px;
                    border-radius: 999px;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-select-text {
                    min-width: 0;
                    overflow: hidden;
                    text-overflow: ellipsis;
                    white-space: nowrap;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-card:focus-visible {
                    background:
                        linear-gradient(#f3f6ff, #f3f6ff) padding-box,
                        linear-gradient(135deg, #2f6bff 0%, #8c3dff 100%) border-box;
                ...
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-detail {
                    ...
                    top: calc(100% + 8px);
                    z-index: 2147483647;
                    width: min(var(--am-ai-max-demand-detail-width, 520px), calc(100vw - 72px));
                    min-width: 0;
                    display: none;
                    gap: 6px;
                    margin: 0 0 2px;
                    ...
                    box-sizing: border-box;
                    pointer-events: none;
                    transform: translateX(var(--am-ai-max-demand-detail-shift, 0px));
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-manage-panel .am-ai-max-demand-detail {
                    top: auto;
                    bottom: calc(100% + 8px);
                }
                #am-campaign-ai-max-batch-popup .am-ai-max-row-crowds .am-ai-max-demand-popover:nth-child(5n) .am-ai-max-demand-detail,
                #am-campaign-ai-max-batch-popup .am-ai-max-demand-grid .am-ai-max-demand-popover:nth-child(5n) .am-ai-max-demand-detail {
                    left: auto;
                    right: 0;
                }
