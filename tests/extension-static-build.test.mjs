...
test('extension manifest 使用 Chrome 规范版本并保留展示版本', () => {
  assert.equal(normalizeExtensionManifestVersion(outputs.version), manifest.version);
  assert.doesNotMatch(manifest.version, /(^|\.)(?:0[0-9]+)/, 'manifest.version 不能包含带前导零的分段');
