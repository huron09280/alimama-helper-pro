...
// @version      5.15
// @description  交互优化版：增加加购成本计算、花费占比、预算分类占比、性能优化。包含状态记忆、胶囊按钮UI、日志折叠、报表直连下载拦截。
// @author       Gemini
// @match        *://alimama.com/*
// @match        *://*.alimama.com/*
                ...
                <div id="am-helper-panel">
                    ...
                    <div class="am-header">
                        <span class="am-title">
                            ...
                            阿里助手 Pro
                            <span class="am-version">v5.15</span>
                        </span>
